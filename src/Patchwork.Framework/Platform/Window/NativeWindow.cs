...
{
    public abstract partial class NativeWindow : Initializable, INativeWindow, IEquatable<NativeWindow>
    {
        #region Events
        ...
        protected NativeWindow(INativeObject parent, NativeWindowDefinition definition) : this() 
        {
        ...
        public void Initialize(NativeWindowDefinition definition)
        {
            m_cache.Definition = definition;
            m_isInitialized = false;
        ...
        /// <inheritdoc />
        public bool Equals(INativeWindow other)
        {
            if (ReferenceEquals(null, other)) return false;
            if (ReferenceEquals(this, other)) return true;
