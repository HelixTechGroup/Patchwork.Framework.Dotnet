...
namespace Patchwork.Framework.Platform
{
    ...
    {        
        ...
        public WindowsWindow(INativeObject parent, NativeWindowDefinition definition) : base(parent, definition)
        {
            ...
            m_windowClass = "ShieldWindow-" + Guid.NewGuid().ToString();
        }
        ...
        public bool Equals(WindowsWindow other)
        {
            ...
            return base.Equals(other) && Equals(m_wndProc, other.m_wndProc) && string.Equals(m_windowClass, other.m_windowClass, StringComparison.OrdinalIgnoreCase);
        }
