...
namespace Patchwork.Framework.Platform.Interop.User32
{
    ...
    public static class Methods
    {
        ...
        [DllImport(LibraryName, CharSet = Properties.BuildCharSet)]
        public static extern IntPtr SetWindowsHookEx(WindowHookType idHook, HookProc lpfn, IntPtr hMod, uint dwThreadId);
        ...
        [DllImport(LibraryName, CharSet = Properties.BuildCharSet)]
        public static extern bool PostMessage(IntPtr hWnd, WindowsMessageIds msg, IntPtr wParam, IntPtr lParam);
