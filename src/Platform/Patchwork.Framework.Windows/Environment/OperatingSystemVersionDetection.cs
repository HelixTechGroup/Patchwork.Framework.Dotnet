...
{
    public sealed class OperatingSystemVersionDetection
    {
        #region Members
        private readonly Version m_osVersion;
        private readonly PlatformID m_platform;
        #endregion
        ...
        public OperatingSystemVersionDetection(Version osVersion, PlatformID platform)
        {
        ...
        public string Edition
        {
            get
            {
                ...
                if (GetVersionEx(ref osVersionInfo))
                {
                    ...
                    {
                        int ed;
                        if (GetProductInfo(majorVersion,
                                           minorVersion,
        ...
        {
            get { return int.Parse(RegistryRead(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion", "CurrentBuildNumber", "0")); }
        }
        #endregion BUILD
        ...
        {
            get { return new Version(MajorVersion, MinorVersion, BuildVersion, RevisionVersion); }
        }
        #endregion VERSION
        #endregion FULL
