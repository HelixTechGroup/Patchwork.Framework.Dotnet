namespace Patchwork.Framework.Platform.Interop.GdiPlus
{
    public class CustomLineCap
    {
            ...
            )
        {
            ...
            lastResult = NativeMethods.GdiPlus.GdipCreateCustomLineCap(
        ...
        ~CustomLineCap()
        {
            NativeMethods.GdiPlus.GdipDeleteCustomLineCap(nativeCap);
        }

        public GpStatus SetStrokeCaps(GpLineCap startCap, GpLineCap endCap)
        {
            return SetStatus(NativeMethods.GdiPlus.GdipSetCustomLineCapStrokeCaps(nativeCap,
                                                                                  startCap, endCap));
        }
