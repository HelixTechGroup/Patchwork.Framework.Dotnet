...
namespace Patchwork.Framework.Platform.Interop.GdiPlus
{
    ...
    public struct GpMatrix
    {
        ...
        public static implicit operator IntPtr(GpMatrix obj)
        {
            return obj.ptr;
        }

        public static implicit operator GpMatrix(IntPtr obj)
        {
            return new GpMatrix() {ptr = obj};
        }
    }
    ...
    public struct GpBrush
    {
        ...
        public static implicit operator GpBrush(IntPtr obj) { return FromPointer(obj); }

        public static GpBrush FromPointer(IntPtr pointer)
        {
            return new GpBrush()
            {
                ptr = pointer
    ...
    public struct GpHatch
    {
        ...
        public static implicit operator GpHatch(IntPtr obj)
        {
            return FromPointer(obj);
        }

        public static GpHatch FromPointer(IntPtr pointer)
        {
            return new GpHatch()
                   {
                       ptr = pointer
    ...
    public struct GpTexture
    {
        ...
        public static implicit operator IntPtr(GpTexture obj)
        {
            return obj.ptr;
        }

        public static implicit operator GpTexture(IntPtr obj)
        {
            return FromPointer(obj);
        }

        public static GpTexture FromPointer(IntPtr pointer)
        {
            return new GpTexture()
                   {
                       ptr = pointer
                   };
        }
    ...
    public struct GpSolidFill
    {
        ...
        public static implicit operator GpSolidFill(IntPtr obj)
        {
            return FromPointer(obj);
        }

        public static GpSolidFill FromPointer(IntPtr pointer)
        {
            return new GpSolidFill()
                   {
                       ptr = pointer
                   };
        }
    ...
    public struct GpPathGradient
    {
        ...
        public static implicit operator GpPathGradient(IntPtr obj)
        {
            return FromPointer(obj);
        }

        public static GpPathGradient FromPointer(IntPtr pointer)
        {
            return new GpPathGradient()
                   {
                       ptr = pointer
                   };
        }
    ...
    public struct GpLineGradient
    {
        ...
        public static implicit operator GpLineGradient(IntPtr obj)
        {
            return FromPointer(obj);
        }

        public static GpLineGradient FromPointer(IntPtr pointer)
        {
            return new GpLineGradient()
                   {
                       ptr = pointer
                   };
        }
    ...
    public struct GpRegion
    {
        ...
        public static implicit operator GpRegion(IntPtr obj)
        {
            return FromPointer(obj);
        }

        public static GpRegion FromPointer(IntPtr pointer)
        {
            return new GpRegion()
                   {
                       ptr = pointer
    ...
    public struct GpImageAttributes
    {
        ...
        public static implicit operator IntPtr(GpImageAttributes obj)
        {
            return obj.ptr;
        }

        public static implicit operator GpImageAttributes(IntPtr obj)
        {
            return new GpImageAttributes() { ptr = obj };
        }
}
