...
namespace Patchwork.Framework.Platform.Interop.GdiPlus
{
    public partial class GraphicsPlus : IDisposable
    {
        ...
        public GraphicsPlus(Graphics g)
        {
            ...
            lastResult = NativeMethods.GdiPlus.GdipCreateFromHDC(hdc, out Graphics);
        ...
        public GraphicsPlus(HDC hdc, HANDLE hdevice)
        {
            ...
            lastResult = NativeMethods.GdiPlus.GdipCreateFromHDC2(hdc, hdevice, out Graphics);
        ...
        public GraphicsPlus(HWND hwnd, bool icm)
        {
            ...
            if (icm)
            {
                lastResult = NativeMethods.GdiPlus.GdipCreateFromHWNDICM(hwnd, out Graphics);
            }
            else
            {
                lastResult = NativeMethods.GdiPlus.GdipCreateFromHWND(hwnd, out Graphics);
            }
        ...
        public GraphicsPlus(ImagePlus image)
        {
            ...
            if (image != null)
            {
                lastResult = NativeMethods.GdiPlus.GdipGetImageGraphicsContext(image.nativeImage, out Graphics);
            }
            SetNativeGraphics(Graphics);
        }
        ...
        {
            NativeMethods.GdiPlus.GdipFlush(nativeGraphics, intention);
        }
        ...
        public HDC GetHDC()
        {
            ...
            SetStatus(NativeMethods.GdiPlus.GdipGetDC(nativeGraphics, out hdc));
        ...
        {
            SetStatus(NativeMethods.GdiPlus.GdipReleaseDC(nativeGraphics, hdc));
        }
        ...
        {
            SetStatus(
                NativeMethods.GdiPlus.GdipSetRenderingOrigin(
                                                             nativeGraphics, x, y
                                                            )
            );
        }
        ...
        {
            SetStatus(
                NativeMethods.GdiPlus.GdipGetRenderingOrigin(
        ...
        private SmoothingMode GetSmoothingMode()
        {
            ...
            SetStatus(NativeMethods.GdiPlus.GdipGetSmoothingMode(nativeGraphics,
                                                                 out smoothingMode));
        ...
        {
            SetStatus(NativeMethods.GdiPlus.GdipSetSmoothingMode(nativeGraphics,
                                                                 smoothingMode));
        }
        ...
        {
            SetStatus(NativeMethods.GdiPlus.GdipDrawLine(nativeGraphics, pen.nativePen, x1, y1, x2, y2));
        }
        ...
        {
            SetStatus(NativeMethods.GdiPlus.GdipDrawLines(nativeGraphics,
                                                          pen.nativePen,
        ...
        {
            SetStatus(NativeMethods.GdiPlus.GdipDrawLineI(nativeGraphics, pen.nativePen, x1, y1, x2, y2));
        }
        ...
        {
            SetStatus(NativeMethods.GdiPlus.GdipDrawLinesI(nativeGraphics,
                                                           pen.nativePen,
                                                           points,
                                                           points.Length));
        }
        ...
        public void DrawPie(PenPlus pen,
                       ...
                       float sweepAngle)
        {
            SetStatus(NativeMethods.GdiPlus.GdipDrawPie(nativeGraphics,
                                                        pen.nativePen,
                                                        x,
                                                        y,
                                                        width,
        ...
        public void DrawPie(PenPlus pen,
                       ...
                       float sweepAngle)
        {
            SetStatus(NativeMethods.GdiPlus.GdipDrawPieI(nativeGraphics,
                                                         pen.nativePen,
                                                         x,
                                                         y,
                                                         width,
        ...
        public void DrawPath(PenPlus pen,
                         GraphicsPath path)
        {
            SetStatus(NativeMethods.GdiPlus.GdipDrawPath(nativeGraphics,
        ...
        {
            SetStatus(NativeMethods.GdiPlus.GdipGraphicsPlusClear(nativeGraphics,color.ToArgb()));
        }
        ...
        public void FillRectangle(BrushPlus brush,
                             ...
                             float height)
        {
            SetStatus(NativeMethods.GdiPlus.GdipFillRectangle(nativeGraphics,
        ...
        public void FillRectangles(BrushPlus brush,
                               RectangleF[] rects)
        {
            SetStatus(NativeMethods.GdiPlus.GdipFillRectangles(nativeGraphics,
                                                               brush.nativeBrush,
                                                               rects, rects.Length));
        }
        ...
        public void FillRectangle(BrushPlus brush,
                             ...
                             int height)
        {
            SetStatus(NativeMethods.GdiPlus.GdipFillRectangleI(nativeGraphics,
                                                               brush.nativeBrush,
                                                               x,
                                                               y,
                                                               width,
        ...
        public void FillRectangles(BrushPlus brush,
                               Rectangle[] rects)
        {
            SetStatus(NativeMethods.GdiPlus.GdipFillRectanglesI(nativeGraphics,
                                                                brush.nativeBrush,
                                                                rects,
                                                                rects.Length));
        }
        ...
        public void FillPie(BrushPlus brush,
                       ...
                       float sweepAngle)
        {
            SetStatus(NativeMethods.GdiPlus.GdipFillPie(nativeGraphics,
                                                        brush.nativeBrush, x, y,
        ...
        public void FillPie(BrushPlus brush,
                       ...
                       float sweepAngle)
        {
            SetStatus(NativeMethods.GdiPlus.GdipFillPieI(nativeGraphics,
                                                         brush.nativeBrush,
                                                         x,
                                                         y,
                                                         width,
        ...
        {
            SetStatus(NativeMethods.GdiPlus.GdipFillPath(nativeGraphics, brush.nativeBrush, path.nativePath));
        }
        ...
        {
            SetStatus(NativeMethods.GdiPlus.GdipDrawImage(nativeGraphics,
        ...
        public void DrawImage(ImagePlus image,  PointF[] destPoints)
        {
            ...
            SetStatus(NativeMethods.GdiPlus.GdipDrawImagePoints(nativeGraphics,
        ...
        public void DrawImage(ImagePlus image,  Point[] destPoints)
        {
            ...
            SetStatus(NativeMethods.GdiPlus.GdipDrawImagePointsI(nativeGraphics,
                                                                 image != null ? image.nativeImage
                                                                     : null,
                                                                 destPoints,
                                                                 count));
        ...
        public void DrawImage(ImagePlus image,
                         ...
                         float srcwidth,
                         float srcheight,
                         NativeMethods.GdiPlus.Unit srcUnit)
        {
            NativeMethods.GdiPlus.Unit unit;
            RectangleF bounds = image.GetBounds(out unit);
        ...
        {
            SetStatus(NativeMethods.GdiPlus.GdipDrawImageRectRect(nativeGraphics,
                                                                  image != null ? image.nativeImage
                                                                      : null,
                                                                  destRect.X,
                                                                  destRect.Y,
        ...
        public void DrawImage(ImagePlus image,
                         ...
                         NativeMethods.GdiPlus.Unit srcUnit,
                          ImageAttributesPlus imageAttributes)
        {
            SetStatus(NativeMethods.GdiPlus.GdipDrawImagePointsRectI(nativeGraphics,
                                                                     image != null ? image.nativeImage
                                                                         : null,
                                                                     destPoints,
                                                                     destPoints.Length,
        ...
        bool IsVisible(Point point)
        {
            ...
            SetStatus(NativeMethods.GdiPlus.GdipIsVisiblePathPointI(new GpPath(),
                                                                    point.X,
                                                                    point.Y,
                                                                    nativeGraphics,
                                                                    out booln));
        ...
        bool IsVisible(PointF point)
        {
            ...
            SetStatus(NativeMethods.GdiPlus.GdipIsVisiblePathPoint(new GpPath(),
                                                                   point.X,
                                                                   point.Y,
                                                                   nativeGraphics,
                                                                   out booln));
        ...
        public GraphicsState Save()
        {
            ...
            SetStatus(NativeMethods.GdiPlus.GdipSaveGraphics(nativeGraphics, out gstate));
       ...
       public  void Restore(GraphicsState gstate)
        {
            SetStatus(NativeMethods.GdiPlus.GdipRestoreGraphics(nativeGraphics, gstate));
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            {
                NativeMethods.GdiPlus.GdipDeleteGraphics(nativeGraphics);
