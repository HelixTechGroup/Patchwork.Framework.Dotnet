...
namespace Patchwork.Framework.Platform.Interop.GdiPlus.NativeMethods
{
    ...
    {
        [DllImport(dllName)]
        extern static internal GpStatus GdipCreatePen1(int color, float width, GraphicsUnit unit, out GpPen pen);

        [DllImport(dllName)]
        extern static internal GpStatus GdipCreatePen1(int color, float width, GraphicsUnit unit, out IntPtr hPen);

        [DllImport(dllName)]
        extern static internal GpStatus GdipCreatePen2(GpBrush brush, float width, GraphicsUnit unit, out GpPen pen);
        ...
        [DllImport(dllName)]
        extern static internal GpStatus GdipSetPenUnit(GpPen pen, GraphicsUnit unit);

        [DllImport(dllName)]
        extern static internal GpStatus GdipGetPenUnit(GpPen pen, out GraphicsUnit unit);
