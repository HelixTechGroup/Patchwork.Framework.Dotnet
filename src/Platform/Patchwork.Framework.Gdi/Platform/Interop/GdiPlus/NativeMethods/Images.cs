...
namespace Patchwork.Framework.Platform.Interop.GdiPlus.NativeMethods
{
    internal partial class GdiPlus
    {
        ...
        [DllImport(dllName)]
        internal static extern GpStatus
        GdipGetImageBounds(GpImage image, out RectangleF srcRect, out GraphicsUnit srcGraphicsUnit);
        [DllImport(dllName)]
        internal static extern GpStatus
        GdipGetImageBounds(GpImage image, float[] srcRect, GraphicsUnit srcGraphicsUnit);
        [DllImport(dllName)]
        internal static extern GpStatus
        GdipGetImageBounds(GpImage image, byte[] srcRect, GraphicsUnit srcGraphicsUnit);
