...
namespace Patchwork.Framework.Platform.Interop.GdiPlus
{
    public class ImageAttributesPlus
    {
        public ImageAttributesPlus()
        {
            ...
            lastResult = NativeMethods.GdiPlus.GdipCreateImageAttributes(out nativeImageAttr);
        }

        ~ImageAttributesPlus()
        {
            NativeMethods.GdiPlus.GdipDisposeImageAttributes(nativeImageAttr);
        }
        ...
        ImageAttributesPlus Clone()
        {
            ...
            SetStatus(NativeMethods.GdiPlus.GdipCloneImageAttributes(
                                                                     nativeImageAttr,
                                                                     out clone));
        ...
        {
            return SetStatus(NativeMethods.GdiPlus.GdipSetImageAttributesToIdentity(nativeImageAttr, type));
        }

        GpStatus Reset(ColorAdjustType type )
        {
            return SetStatus(NativeMethods.GdiPlus.GdipResetImageAttributes(nativeImageAttr,type));
        }
        ...
        {
            return SetStatus(NativeMethods.GdiPlus.GdipSetImageAttributesGamma(
                                                                               nativeImageAttr,
                                                                               type,
                                                                               true,
                                                                               gamma));
        ...
        {
            return SetStatus(NativeMethods.GdiPlus.GdipSetImageAttributesNoOp(
                                                                              nativeImageAttr,
                                                                              type,
                                                                              true));
        }
        ...
        {
            return SetStatus(NativeMethods.GdiPlus.GdipSetImageAttributesColorKeys(
                                                                                   nativeImageAttr,
                                                                                   type,
                                                                                   true,
                                                                                   colorLow.ToArgb(),
