                                                ...
                                                View.IOnFocusChangeListener
        {
            ...
            public void OnLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom)
            {
                ...
                if (v.Width != oldWidth || v.Height != oldHeight)
                {
                    ...
                    Core.MessagePump.PushWindowResizingMessage(m_window, newSize);
                    Core.MessagePump.PushWindowResizedMessage(m_window, newSize);
                }
                ...
                if (left != oldLeft || top != oldTop)
                {
                    ...
                    Core.MessagePump.PushWindowMovingMessage(m_window, newPos);
                    Core.MessagePump.PushWindowMovedMessage(m_window, newPos);
                }
